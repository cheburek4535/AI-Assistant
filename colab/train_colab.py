...
class B2BAssistantTrainer:
    ...
    def load_dataset(self, data_dir="/content/ready_dataset"):
    ...
    def train(self, output_dir="/content/drive/MyDrive/b2b_assistant_model"):
        ...
        training_args = TrainingArguments(
            ...
            num_train_epochs=3,
            per_device_train_batch_size=6,  # Оптимально для T4
            ...
            save_strategy="steps",
            save_steps=1000,
            save_total_limit=5,  # Хранить 5 чекпоинтов
            load_best_model_at_end=True,
            metric_for_best_model="eval_loss",
            greater_is_better=False,
            fp16=True,  # ВКЛЮЧИТЬ для T4
    ...
    def evaluate_model(self, test_file="/content/ready_dataset/test.jsonl", max_samples=100):
...
def interactive_test(model_path="/content/drive/MyDrive/b2b_assistant_model"):
    """Интерактивное тестирование модели"""

    print("🤖 ЗАГРУЗКА LoRA МОДЕЛИ...")

    # ✅ 1. БАЗОВАЯ модель
    base_model_name = "sberbank-ai/rugpt3small_based_on_gpt2"  # ruGPT-3Small
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", default="/content/drive/MyDrive/b2b_assistant_model",
                        help="Путь к модели")  # ИЗМЕНИТЬ ПУТЬ
    parser.add_argument("--data_dir", default="/content/ready_dataset",
                        help="Путь к данным")  # ИЗМЕНИТЬ ПУТЬ
